...
insertInto:void 0});c.locals&&(d.exports=c.locals)},function(d,c,a){c=d.exports=a(29)(!1);c.push([d.i,":root{--df-messenger-bot-message:#fff;--df-messenger-button-titlebar-color:#040061;--df-messenger-button-titlebar-font-color:#fff;--df-messenger-chat-background-color:#fafafa;--df-messenger-font-color:rgba(0,0,0,.87);--df-messenger-input-box-color:#fff;--df-messenger-input-font-color:rgba(0,0,0,.87);--df-messenger-input-placeholder-font-color:#757575;--df-messenger-minimized-chat-close-icon-color:rgba(0,0,0,.87);--df-messenger-send-icon:#040061;--df-messenger-user-message:#ddd;--df-messenger-chip-color:#fff;--df-messenger-chip-border-color:#e0e0e0}",
